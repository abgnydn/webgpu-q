...
// The next six are NOT from the EMSL retrieval above: B and Ne were added in
// 1bd245f and generated by scripts/gen-basis-tables.py from pyscf.gto.basis.load,
// like the row-3 blocks further down. They sit here only to keep the aug-cc-pVDZ
// diffuse set in one place. Flagged because "integrals.ts marks the generated
// regions" was otherwise false for exactly these six constants.
...
// End of the generated B/Ne block; EMSL-sourced constants resume below.
...
// ═════════════════════════════════════════════════════════════
// Third row: Na, Mg, Al, Si, P, S, Cl, Ar  (added 2026-08-10)
//
// Generated by scripts/gen-basis-tables.py from PySCF — not
// transcribed. Structure is uniform across the whole row, so
// atoms.ts needs one row-3 code path rather than eight:
//   STO-3G   3s + 2p            ->  9 Cartesian functions
//   cc-pVDZ  4s + 3p + 1d       -> 19 Cartesian / 18 spherical
//   aug      +1s +1p +1d
// Note the d function appears from Na onward, so the Cartesian-vs-
// spherical convention difference applies to this entire row.
// ═════════════════════════════════════════════════════════════

// STO-3G M-shell (3s/3p) contraction coefficients. Universal across
// Na-Ar exactly as the L-shell constants are across Li-Ne; verified
// identical for all eight elements to 1e-6. The 3s and 3p shells
// share one exponent set, mirroring the 2s/2p L-shell.
const STO3G_M_3S_C = [-0.219620369, 0.2255954336, 0.900398426] as const;
const STO3G_M_3P_C = [0.01058760429, 0.5951670053, 0.462001012] as const;

export const STO3G_NA_1S = {
  alpha: [250.77243, 45.678511, 12.362388] as const,
  c: STO3G_S_C,
};
export const STO3G_NA_2S = {
  alpha: [12.040193, 2.7978819, 0.909958] as const,
  c: STO3G_L_2S_C,
};
export const STO3G_NA_3S = {
  alpha: [1.4787406, 0.4125649, 0.1614751] as const,
  c: STO3G_M_3S_C,
};
export const STO3G_NA_2P = {
  alpha: [12.040193, 2.7978819, 0.909958] as const,
  c: STO3G_L_2P_C,
};
export const STO3G_NA_3P = {
  alpha: [1.4787406, 0.4125649, 0.1614751] as const,
  c: STO3G_M_3P_C,
};
export const STO3G_MG_1S = {
  alpha: [299.2374, 54.50647, 14.75158] as const,
  c: STO3G_S_C,
};
export const STO3G_MG_2S = {
  alpha: [15.12182, 3.513987, 1.142857] as const,
  c: STO3G_L_2S_C,
};
export const STO3G_MG_3S = {
  alpha: [1.395448, 0.389326, 0.15238] as const,
  c: STO3G_M_3S_C,
};
export const STO3G_MG_2P = {
  alpha: [15.12182, 3.513987, 1.142857] as const,
  c: STO3G_L_2P_C,
};
export const STO3G_MG_3P = {
  alpha: [1.395448, 0.389326, 0.15238] as const,
  c: STO3G_M_3P_C,
};
export const STO3G_AL_1S = {
  alpha: [351.4214767, 64.01186067, 17.32410761] as const,
  c: STO3G_S_C,
};
export const STO3G_AL_2S = {
  alpha: [18.89939621, 4.391813233, 1.42835397] as const,
  c: STO3G_L_2S_C,
};
export const STO3G_AL_3S = {
  alpha: [1.395448293, 0.3893265318, 0.1523797659] as const,
  c: STO3G_M_3S_C,
};
export const STO3G_AL_2P = {
  alpha: [18.89939621, 4.391813233, 1.42835397] as const,
  c: STO3G_L_2P_C,
};
export const STO3G_AL_3P = {
  alpha: [1.395448293, 0.3893265318, 0.1523797659] as const,
  c: STO3G_M_3P_C,
};
export const STO3G_SI_1S = {
  alpha: [407.7975514, 74.28083305, 20.10329229] as const,
  c: STO3G_S_C,
};
export const STO3G_SI_2S = {
  alpha: [23.19365606, 5.389706871, 1.752899952] as const,
  c: STO3G_L_2S_C,
};
export const STO3G_SI_3S = {
  alpha: [1.478740622, 0.4125648801, 0.1614750979] as const,
  c: STO3G_M_3S_C,
};
export const STO3G_SI_2P = {
  alpha: [23.19365606, 5.389706871, 1.752899952] as const,
  c: STO3G_L_2P_C,
};
export const STO3G_SI_3P = {
  alpha: [1.478740622, 0.4125648801, 0.1614750979] as const,
  c: STO3G_M_3P_C,
};
export const STO3G_P_1S = {
  alpha: [468.3656378, 85.31338559, 23.08913156] as const,
  c: STO3G_S_C,
};
export const STO3G_P_2S = {
  alpha: [28.03263958, 6.514182577, 2.118614352] as const,
  c: STO3G_L_2S_C,
};
export const STO3G_P_3S = {
  alpha: [1.743103231, 0.4863213771, 0.1903428909] as const,
  c: STO3G_M_3S_C,
};
export const STO3G_P_2P = {
  alpha: [28.03263958, 6.514182577, 2.118614352] as const,
  c: STO3G_L_2P_C,
};
export const STO3G_P_3P = {
  alpha: [1.743103231, 0.4863213771, 0.1903428909] as const,
  c: STO3G_M_3P_C,
};
export const STO3G_S_1S = {
  alpha: [533.1257359, 97.1095183, 26.28162542] as const,
  c: STO3G_S_C,
};
export const STO3G_S_2S = {
  alpha: [33.32975173, 7.745117521, 2.518952599] as const,
  c: STO3G_L_2S_C,
};
export const STO3G_S_3S = {
  alpha: [2.029194274, 0.5661400518, 0.2215833792] as const,
  c: STO3G_M_3S_C,
};
export const STO3G_S_2P = {
  alpha: [33.32975173, 7.745117521, 2.518952599] as const,
  c: STO3G_L_2P_C,
};
export const STO3G_S_3P = {
  alpha: [2.029194274, 0.5661400518, 0.2215833792] as const,
  c: STO3G_M_3P_C,
};
export const STO3G_CL_1S = {
  alpha: [601.3456136, 109.5358542, 29.64467686] as const,
  c: STO3G_S_C,
};
export const STO3G_CL_2S = {
  alpha: [38.96041889, 9.053563477, 2.944499834] as const,
  c: STO3G_L_2S_C,
};
export const STO3G_CL_3S = {
  alpha: [2.129386495, 0.5940934274, 0.232524141] as const,
  c: STO3G_M_3S_C,
};
export const STO3G_CL_2P = {
  alpha: [38.96041889, 9.053563477, 2.944499834] as const,
  c: STO3G_L_2P_C,
};
export const STO3G_CL_3P = {
  alpha: [2.129386495, 0.5940934274, 0.232524141] as const,
  c: STO3G_M_3P_C,
};
export const STO3G_AR_1S = {
  alpha: [674.4465184, 122.8512753, 33.24834945] as const,
  c: STO3G_S_C,
};
export const STO3G_AR_2S = {
  alpha: [45.16424392, 10.495199, 3.413364448] as const,
  c: STO3G_L_2S_C,
};
export const STO3G_AR_3S = {
  alpha: [2.621366518, 0.731354605, 0.2862472356] as const,
  c: STO3G_M_3S_C,
};
export const STO3G_AR_2P = {
  alpha: [45.16424392, 10.495199, 3.413364448] as const,
  c: STO3G_L_2P_C,
};
export const STO3G_AR_3P = {
  alpha: [2.621366518, 0.731354605, 0.2862472356] as const,
  c: STO3G_M_3P_C,
};

export const CCPVDZ_NA_1S = {
  alpha: [
    31700.0, 4755.0, 1082.0, 306.4, 99.53, 35.42, 13.3, 4.392, 1.676, 0.5889,
    0.0564,
  ] as const,
  c: [
    0.000458878, 0.0035507, 0.0182618, 0.071665, 0.212346, 0.416203, 0.37302,
    0.0625054, -0.00624532, 0.00243374, -0.000442381,
  ] as const,
};
export const CCPVDZ_NA_2S = {
  alpha: [
    31700.0, 4755.0, 1082.0, 306.4, 99.53, 35.42, 13.3, 4.392, 1.676, 0.5889,
    0.0564,
  ] as const,
  c: [
    -0.000112162, -0.000868512, -0.0045133, -0.0181436, -0.0580799, -0.137653,
    -0.193908, 0.0858009, 0.604419, 0.441719, 0.0130547,
  ] as const,
};
export const CCPVDZ_NA_3S = {
  alpha: [
    31700.0, 4755.0, 1082.0, 306.4, 99.53, 35.42, 13.3, 4.392, 1.676, 0.5889,
    0.0564,
  ] as const,
  c: [
    1.7016e-05, 0.000130693, 0.000687784, 0.00272359, 0.00895529, 0.0207832,
    0.031938, -0.0191368, -0.102595, -0.198945, 0.655952,
  ] as const,
};
export const CCPVDZ_NA_3S_P = {
  alpha: [0.02307] as const,
  c: [1.0] as const,
};
export const CCPVDZ_NA_2P = {
  alpha: [138.1, 32.24, 9.985, 3.484, 1.231, 0.4177, 0.06513] as const,
  c: [
    0.00579641, 0.0415756, 0.162873, 0.359401, 0.449988, 0.227507, 0.00808247,
  ] as const,
};
export const CCPVDZ_NA_3P = {
  alpha: [138.1, 32.24, 9.985, 3.484, 1.231, 0.4177, 0.06513] as const,
  c: [
    -0.000581531, -0.00407306, -0.0167937, -0.0353268, -0.0521971, -0.0168359,
    0.434613,
  ] as const,
};
export const CCPVDZ_NA_3P_P = {
  alpha: [0.02053] as const,
  c: [1.0] as const,
};
export const CCPVDZ_NA_3D = {
  alpha: [0.0973] as const,
  c: [1.0] as const,
};
export const CCPVDZ_MG_1S = {
  alpha: [
    47390.0, 7108.0, 1618.0, 458.4, 149.3, 53.59, 20.7, 8.384, 2.542, 0.8787,
    0.1077,
  ] as const,
  c: [
    0.000346023, 0.00268077, 0.0138367, 0.0551767, 0.16966, 0.364703, 0.406856,
    0.135089, 0.00490884, 0.00028646, 2.6459e-05,
  ] as const,
};
export const CCPVDZ_MG_2S = {
  alpha: [
    47390.0, 7108.0, 1618.0, 458.4, 149.3, 53.59, 20.7, 8.384, 2.542, 0.8787,
    0.1077,
  ] as const,
  c: [
    -8.77839e-05, -0.000674725, -0.00355603, -0.0142154, -0.0476748, -0.114892,
    -0.200676, -0.0341224, 0.570454, 0.542309, 0.0218128,
  ] as const,
};
export const CCPVDZ_MG_3S = {
  alpha: [
    47390.0, 7108.0, 1618.0, 458.4, 149.3, 53.59, 20.7, 8.384, 2.542, 0.8787,
    0.1077,
  ] as const,
  c: [
    1.69628e-05, 0.000129865, 0.000688831, 0.00273533, 0.00931224, 0.0223265,
    0.0411195, 0.00545642, -0.134012, -0.256176, 0.605856,
  ] as const,
};
export const CCPVDZ_MG_3S_P = {
  alpha: [0.03999] as const,
  c: [1.0] as const,
};
export const CCPVDZ_MG_2P = {
  alpha: [179.9, 42.14, 13.13, 4.628, 1.67, 0.5857, 0.1311] as const,
  c: [
    0.00538161, 0.0392418, 0.157445, 0.358535, 0.457226, 0.215918, 0.00664948,
  ] as const,
};
export const CCPVDZ_MG_3P = {
  alpha: [179.9, 42.14, 13.13, 4.628, 1.67, 0.5857, 0.1311] as const,
  c: [
    -0.000865948, -0.00615978, -0.0261519, -0.0570647, -0.0873906, -0.012299,
    0.502085,
  ] as const,
};
export const CCPVDZ_MG_3P_P = {
  alpha: [0.04112] as const,
  c: [1.0] as const,
};
export const CCPVDZ_MG_3D = {
  alpha: [0.187] as const,
  c: [1.0] as const,
};
export const CCPVDZ_AL_1S = {
  alpha: [
    64150.0, 9617.0, 2189.0, 620.5, 202.7, 73.15, 28.55, 11.77, 3.3, 1.173,
    0.1752,
  ] as const,
  c: [
    0.00029025, 0.00225064, 0.0116459, 0.0467377, 0.146299, 0.330283, 0.415861,
    0.189253, 0.0115889, -0.00128385, 0.000425883,
  ] as const,
};
export const CCPVDZ_AL_2S = {
  alpha: [
    64150.0, 9617.0, 2189.0, 620.5, 202.7, 73.15, 28.55, 11.77, 3.3, 1.173,
    0.1752,
  ] as const,
  c: [
    -7.58048e-05, -0.000581791, -0.00308113, -0.0123112, -0.0419781, -0.103371,
    -0.196308, -0.0830002, 0.54104, 0.578796, 0.0288147,
  ] as const,
};
export const CCPVDZ_AL_3S = {
  alpha: [
    64150.0, 9617.0, 2189.0, 620.5, 202.7, 73.15, 28.55, 11.77, 3.3, 1.173,
    0.1752,
  ] as const,
  c: [
    1.75078e-05, 0.000134208, 0.000712442, 0.0028433, 0.00976842, 0.024185,
    0.0474993, 0.0203621, -0.158788, -0.311694, 0.620147,
  ] as const,
};
export const CCPVDZ_AL_3S_P = {
  alpha: [0.06473] as const,
  c: [1.0] as const,
};
export const CCPVDZ_AL_2P = {
  alpha: [258.8, 60.89, 19.14, 6.881, 2.574, 0.9572, 0.2099] as const,
  c: [0.00406847, 0.0306815, 0.129149, 0.320831, 0.453815, 0.275066, 0.0190807] as const,
};
export const CCPVDZ_AL_3P = {
  alpha: [258.8, 60.89, 19.14, 6.881, 2.574, 0.9572, 0.2099] as const,
  c: [
    -0.000748053, -0.00545796, -0.0245371, -0.0582138, -0.0983756, -0.0260064,
    0.46402,
  ] as const,
};
export const CCPVDZ_AL_3P_P = {
  alpha: [0.05986] as const,
  c: [1.0] as const,
};
export const CCPVDZ_AL_3D = {
  alpha: [0.189] as const,
  c: [1.0] as const,
};
export const CCPVDZ_SI_1S = {
  alpha: [
    78860.0, 11820.0, 2692.0, 763.4, 249.6, 90.28, 35.29, 14.51, 4.053,
    1.482, 0.2517,
  ] as const,
  c: [
    0.000270443, 0.00209717, 0.0108506, 0.0436754, 0.137653, 0.316644,
    0.418581, 0.210212, 0.0144952, -0.0020359, 0.000624186,
  ] as const,
};
export const CCPVDZ_SI_2S = {
  alpha: [
    78860.0, 11820.0, 2692.0, 763.4, 249.6, 90.28, 35.29, 14.51, 4.053,
    1.482, 0.2517,
  ] as const,
  c: [
    -7.23177e-05, -0.000555116, -0.00293805, -0.0117687, -0.0402907, -0.100609,
    -0.196528, -0.102382, 0.52719, 0.593251, 0.0332652,
  ] as const,
};
export const CCPVDZ_SI_3S = {
  alpha: [
    78860.0, 11820.0, 2692.0, 763.4, 249.6, 90.28, 35.29, 14.51, 4.053,
    1.482, 0.2517,
  ] as const,
  c: [
    1.85113e-05, 0.000142236, 0.000752185, 0.00302279, 0.0103677, 0.0262563,
    0.0523989, 0.0290959, -0.178003, -0.346874, 0.62302,
  ] as const,
};
export const CCPVDZ_SI_3S_P = {
  alpha: [0.09243] as const,
  c: [1.0] as const,
};
export const CCPVDZ_SI_2P = {
  alpha: [315.9, 74.42, 23.48, 8.488, 3.217, 1.229, 0.2964] as const,
  c: [0.00392656, 0.0298811, 0.127212, 0.320943, 0.455429, 0.268563, 0.0188336] as const,
};
export const CCPVDZ_SI_3P = {
  alpha: [315.9, 74.42, 23.48, 8.488, 3.217, 1.229, 0.2964] as const,
  c: [
    -0.000858302, -0.00630328, -0.0288255, -0.069456, -0.119493, -0.0199581,
    0.510268,
  ] as const,
};
export const CCPVDZ_SI_3P_P = {
  alpha: [0.08768] as const,
  c: [1.0] as const,
};
export const CCPVDZ_SI_3D = {
  alpha: [0.275] as const,
  c: [1.0] as const,
};
export const CCPVDZ_P_1S = {
  alpha: [
    94840.0, 14220.0, 3236.0, 917.1, 299.5, 108.1, 42.18, 17.28, 4.858,
    1.818, 0.3372,
  ] as const,
  c: [
    0.000255509, 0.00198193, 0.010276, 0.0414823, 0.131984, 0.308662, 0.420647,
    0.222878, 0.0164035, -0.00254255, 0.00074805,
  ] as const,
};
export const CCPVDZ_P_2S = {
  alpha: [
    94840.0, 14220.0, 3236.0, 917.1, 299.5, 108.1, 42.18, 17.28, 4.858,
    1.818, 0.3372,
  ] as const,
  c: [
    -6.96939e-05, -0.000535266, -0.00283709, -0.0113983, -0.0392929, -0.0996364,
    -0.197983, -0.11486, 0.518595, 0.601847, 0.0368612,
  ] as const,
};
export const CCPVDZ_P_3S = {
  alpha: [
    94840.0, 14220.0, 3236.0, 917.1, 299.5, 108.1, 42.18, 17.28, 4.858,
    1.818, 0.3372,
  ] as const,
  c: [
    1.91199e-05, 0.000147223, 0.000777912, 0.00314546, 0.01082, 0.0279957,
    0.0563978, 0.035819, -0.193387, -0.372097, 0.624246,
  ] as const,
};
export const CCPVDZ_P_3S_P = {
  alpha: [0.1232] as const,
  c: [1.0] as const,
};
export const CCPVDZ_P_2P = {
  alpha: [370.5, 87.33, 27.59, 10.0, 3.825, 1.494, 0.3921] as const,
  c: [0.00395005, 0.0302492, 0.129554, 0.327594, 0.456992, 0.253086, 0.0168798] as const,
};
export const CCPVDZ_P_3P = {
  alpha: [370.5, 87.33, 27.59, 10.0, 3.825, 1.494, 0.3921] as const,
  c: [
    -0.000959832, -0.00711177, -0.0327122, -0.0795784, -0.135016, -0.00910585,
    0.537802,
  ] as const,
};
export const CCPVDZ_P_3P_P = {
  alpha: [0.1186] as const,
  c: [1.0] as const,
};
export const CCPVDZ_P_3D = {
  alpha: [0.373] as const,
  c: [1.0] as const,
};
export const CCPVDZ_S_1S = {
  alpha: [
    110800.0, 16610.0, 3781.0, 1071.0, 349.8, 126.3, 49.26, 20.16, 5.72,
    2.182, 0.4327,
  ] as const,
  c: [
    0.000247635, 0.00192026, 0.00996192, 0.0402975, 0.128604, 0.30348,
    0.421432, 0.230781, 0.0178971, -0.00297516, 0.000849522,
  ] as const,
};
export const CCPVDZ_S_2S = {
  alpha: [
    110800.0, 16610.0, 3781.0, 1071.0, 349.8, 126.3, 49.26, 20.16, 5.72,
    2.182, 0.4327,
  ] as const,
  c: [
    -6.87039e-05, -0.000527681, -0.00279671, -0.0112651, -0.0388834, -0.0995025,
    -0.19974, -0.12336, 0.513194, 0.60712, 0.0396753,
  ] as const,
};
export const CCPVDZ_S_3S = {
  alpha: [
    110800.0, 16610.0, 3781.0, 1071.0, 349.8, 126.3, 49.26, 20.16, 5.72,
    2.182, 0.4327,
  ] as const,
  c: [
    1.99077e-05, 0.000153483, 0.000809503, 0.00328974, 0.0112967, 0.0296385,
    0.0599851, 0.0413248, -0.207474, -0.392889, 0.63284,
  ] as const,
};
export const CCPVDZ_S_3S_P = {
  alpha: [0.157] as const,
  c: [1.0] as const,
};
export const CCPVDZ_S_2P = {
  alpha: [399.7, 94.19, 29.75, 10.77, 4.119, 1.625, 0.4726] as const,
  c: [0.00447541, 0.0341708, 0.14425, 0.353928, 0.459085, 0.206383, 0.0102141] as const,
};
export const CCPVDZ_S_3P = {
  alpha: [399.7, 94.19, 29.75, 10.77, 4.119, 1.625, 0.4726] as const,
  c: [
    -0.00116251, -0.00865664, -0.0390886, -0.0934625, -0.147994, 0.0301904,
    0.561573,
  ] as const,
};
export const CCPVDZ_S_3P_P = {
  alpha: [0.1407] as const,
  c: [1.0] as const,
};
export const CCPVDZ_S_3D = {
  alpha: [0.479] as const,
  c: [1.0] as const,
};
export const CCPVDZ_CL_1S = {
  alpha: [
    127900.0, 19170.0, 4363.0, 1236.0, 403.6, 145.7, 56.81, 23.23, 6.644,
    2.575, 0.5371,
  ] as const,
  c: [
    0.000241153, 0.00187095, 0.00970827, 0.0393153, 0.125932, 0.299341,
    0.421886, 0.237201, 0.0191531, -0.00334792, 0.000929883,
  ] as const,
};
export const CCPVDZ_CL_2S = {
  alpha: [
    127900.0, 19170.0, 4363.0, 1236.0, 403.6, 145.7, 56.81, 23.23, 6.644,
    2.575, 0.5371,
  ] as const,
  c: [
    -6.78922e-05, -0.000521836, -0.00276513, -0.0111537, -0.0385919, -0.0994848,
    -0.201392, -0.130313, 0.509443, 0.610725, 0.0421549,
  ] as const,
};
export const CCPVDZ_CL_3S = {
  alpha: [
    127900.0, 19170.0, 4363.0, 1236.0, 403.6, 145.7, 56.81, 23.23, 6.644,
    2.575, 0.5371,
  ] as const,
  c: [
    2.04986e-05, 0.000158298, 0.000833639, 0.0033988, 0.0116738, 0.0309622,
    0.0629533, 0.0460257, -0.219312, -0.408773, 0.638465,
  ] as const,
};
export const CCPVDZ_CL_3S_P = {
  alpha: [0.1938] as const,
  c: [1.0] as const,
};
export const CCPVDZ_CL_2P = {
  alpha: [417.6, 98.33, 31.04, 11.19, 4.249, 1.624, 0.5322] as const,
  c: [
    0.00525982, 0.0398332, 0.164655, 0.387322, 0.457072, 0.151636, 0.00181615,
  ] as const,
};
export const CCPVDZ_CL_3P = {
  alpha: [417.6, 98.33, 31.04, 11.19, 4.249, 1.624, 0.5322] as const,
  c: [
    -0.0014357, -0.0107796, -0.0470075, -0.11103, -0.153275, 0.0894609,
    0.579444,
  ] as const,
};
export const CCPVDZ_CL_3P_P = {
  alpha: [0.162] as const,
  c: [1.0] as const,
};
export const CCPVDZ_CL_3D = {
  alpha: [0.6] as const,
  c: [1.0] as const,
};
export const CCPVDZ_AR_1S = {
  alpha: [
    145700.0, 21840.0, 4972.0, 1408.0, 459.7, 165.9, 64.69, 26.44, 7.628,
    2.996, 0.6504,
  ] as const,
  c: [
    0.0002367, 0.00183523, 0.0095286, 0.0386283, 0.124081, 0.296471, 0.422068,
    0.241711, 0.0200509, -0.00361, 0.000975607,
  ] as const,
};
export const CCPVDZ_AR_2S = {
  alpha: [
    145700.0, 21840.0, 4972.0, 1408.0, 459.7, 165.9, 64.69, 26.44, 7.628,
    2.996, 0.6504,
  ] as const,
  c: [
    -6.7491e-05, -0.000518522, -0.00274825, -0.0111007, -0.038482, -0.0997599,
    -0.203088, -0.135608, 0.507195, 0.612898, 0.0442968,
  ] as const,
};
export const CCPVDZ_AR_3S = {
  alpha: [
    145700.0, 21840.0, 4972.0, 1408.0, 459.7, 165.9, 64.69, 26.44, 7.628,
    2.996, 0.6504,
  ] as const,
  c: [
    2.10457e-05, 0.000162565, 0.000855463, 0.00349745, 0.0120156, 0.0321368,
    0.0655279, 0.049937, -0.229769, -0.421006, 0.642331,
  ] as const,
};
export const CCPVDZ_AR_3S_P = {
  alpha: [0.2337] as const,
  c: [1.0] as const,
};
export const CCPVDZ_AR_2P = {
  alpha: [453.7, 106.8, 33.73, 12.13, 4.594, 1.678, 0.5909] as const,
  c: [
    0.00570555, 0.043046, 0.176591, 0.406863, 0.452549, 0.122801, -0.00445996,
  ] as const,
};
export const CCPVDZ_AR_3P = {
  alpha: [453.7, 106.8, 33.73, 12.13, 4.594, 1.678, 0.5909] as const,
  c: [
    -0.00160655, -0.0121714, -0.0520789, -0.123737, -0.151619, 0.142425,
    0.584501,
  ] as const,
};
export const CCPVDZ_AR_3P_P = {
  alpha: [0.1852] as const,
  c: [1.0] as const,
};
export const CCPVDZ_AR_3D = {
  alpha: [0.738] as const,
  c: [1.0] as const,
};

export const AUG_CCPVDZ_NA_DIFFUSE_S = {
  alpha: [0.00725] as const,
  c: [1.0] as const,
};
export const AUG_CCPVDZ_NA_DIFFUSE_P = {
  alpha: [0.00633] as const,
  c: [1.0] as const,
};
export const AUG_CCPVDZ_NA_DIFFUSE_D = {
  alpha: [0.0468] as const,
  c: [1.0] as const,
};
export const AUG_CCPVDZ_MG_DIFFUSE_S = {
  alpha: [0.01488] as const,
  c: [1.0] as const,
};
export const AUG_CCPVDZ_MG_DIFFUSE_P = {
  alpha: [0.00935] as const,
  c: [1.0] as const,
};
export const AUG_CCPVDZ_MG_DIFFUSE_D = {
  alpha: [0.0595] as const,
  c: [1.0] as const,
};
export const AUG_CCPVDZ_AL_DIFFUSE_S = {
  alpha: [0.0231] as const,
  c: [1.0] as const,
};
export const AUG_CCPVDZ_AL_DIFFUSE_P = {
  alpha: [0.0153] as const,
  c: [1.0] as const,
};
export const AUG_CCPVDZ_AL_DIFFUSE_D = {
  alpha: [0.0535] as const,
  c: [1.0] as const,
};
export const AUG_CCPVDZ_SI_DIFFUSE_S = {
  alpha: [0.0332] as const,
  c: [1.0] as const,
};
export const AUG_CCPVDZ_SI_DIFFUSE_P = {
  alpha: [0.025] as const,
  c: [1.0] as const,
};
export const AUG_CCPVDZ_SI_DIFFUSE_D = {
  alpha: [0.0823] as const,
  c: [1.0] as const,
};
export const AUG_CCPVDZ_P_DIFFUSE_S = {
  alpha: [0.0417] as const,
  c: [1.0] as const,
};
export const AUG_CCPVDZ_P_DIFFUSE_P = {
  alpha: [0.0343] as const,
  c: [1.0] as const,
};
export const AUG_CCPVDZ_P_DIFFUSE_D = {
  alpha: [0.113] as const,
  c: [1.0] as const,
};
export const AUG_CCPVDZ_S_DIFFUSE_S = {
  alpha: [0.0507] as const,
  c: [1.0] as const,
};
export const AUG_CCPVDZ_S_DIFFUSE_P = {
  alpha: [0.0399] as const,
  c: [1.0] as const,
};
export const AUG_CCPVDZ_S_DIFFUSE_D = {
  alpha: [0.152] as const,
  c: [1.0] as const,
};
export const AUG_CCPVDZ_CL_DIFFUSE_S = {
  alpha: [0.0608] as const,
  c: [1.0] as const,
};
export const AUG_CCPVDZ_CL_DIFFUSE_P = {
  alpha: [0.0466] as const,
  c: [1.0] as const,
};
export const AUG_CCPVDZ_CL_DIFFUSE_D = {
  alpha: [0.196] as const,
  c: [1.0] as const,
};
export const AUG_CCPVDZ_AR_DIFFUSE_S = {
  alpha: [0.0709] as const,
  c: [1.0] as const,
};
export const AUG_CCPVDZ_AR_DIFFUSE_P = {
  alpha: [0.0533] as const,
  c: [1.0] as const,
};
export const AUG_CCPVDZ_AR_DIFFUSE_D = {
  alpha: [0.24] as const,
  c: [1.0] as const,
};
