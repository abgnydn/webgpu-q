...
\midrule
B (brick-wall)        & 2-qubit $\to$ dense $4\times4$  & dispatch          & \textbf{3.04$\times$} ($N{=}20$, $D{=}80$) & 1.0000000 & pass ($\ge2\times$) \\
C (three-qubit tile)  & 5 ops $\to$ dense $8\times8$     & dispatch          & \textbf{4.22$\times$} ($N{=}15$, $D{=}80$) & 0.9999988 & pass ($\ge3\times$) \\
